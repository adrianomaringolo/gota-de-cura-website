...
export function CategoryTile({
  ...
  return (
    <Link
      href={`/${type.id}`}
      className={cn(
        'group relative isolate flex overflow-hidden rounded-2xl bg-brand-darkest',
    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          'from-brand-darkest/92 via-brand-darkest/25 to-transparent',
          'group-hover:from-brand-darkest/96',
        )}
      />
      ...
      <div className="relative mt-auto flex w-full items-end justify-between gap-3 p-4 sm:p-5">
        ...
        <span
          ...
          className={cn(
            ...
            'group-hover:border-white group-hover:bg-white group-hover:text-brand-darkest',
